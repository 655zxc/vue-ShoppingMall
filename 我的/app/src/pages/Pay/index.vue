  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a href="javaScript:void(0);" class="btn" @click="pay">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    ...
    async pay() {
      ...
      //element组件设置
      this.$alert(`<img src=${result} alt="" />`, "微信支付", {
      ...
      if (!this.timer) {
        this.timer = setInterval(async () => {
          //访问订单状态接口
          let result = await this.$API.reqPatStatus(this.$route.query.orderId);
          console.log(result);
          //如果成功
          if (result.code == 200) {
            //清除定时器
